			...
			"item": [
				...
				},
				{
					...
					"request": {
						...
						"header": [],
						"url": {
							"raw": "localhost:2406/admin/delete-category/4af3388b-2738-4ff6-b42e-927cb0ff897f",
							"host": [
								"localhost"
							],
							"port": "2406",
				...
				},
				{
					...
					"request": {
						...
						"header": [],
						"url": {
							"raw": "localhost:2406/admin/restore-category/4af3388b-2738-4ff6-b42e-927cb0ff897f",
							"host": [
								"localhost"
							],
							"port": "2406",
			...
			"item": [
				...
				},
				{
					...
					"request": {
						...
						"header": [],
						"url": {
							"raw": "localhost:2406/api/tm/fdc10d33-043b-4ee0-9d6e-e2a12a3e150a/2/1",
							"host": [
								"localhost"
							],
							"port": "2406",
							"path": [
								"api",
								"tm",
								"fdc10d33-043b-4ee0-9d6e-e2a12a3e150a",
								"2",
								"1"
							]
						}
			...
			"item": [
				...
				},
				{
					...
					"request": {
						...
						"header": [],
						"url": {
							"raw": "localhost:2406/admin/restore-brend/6a31c50a-704f-4b0d-80ae-240ca3094cda",
							"host": [
								"localhost"
							],
							"port": "2406",
				...
				},
				{
					...
					"request": {
						...
						"header": [],
						"url": {
							"raw": "localhost:2406/admin/delete-brend/6a31c50a-704f-4b0d-80ae-240ca3094cda",
							"host": [
								"localhost"
							],
							"port": "2406",
			...
			"item": [
					...
					"request": {
						...
						"body": {
							...
							"formdata": [
								{
									"key": "brend_id",
									"value": "214be879-65c3-4710-86b4-3fc3bce2e974",
									"type": "default"
								},
								{
									"key": "price",
								...
								{
									"key": "category_id",
									"value": "7f453dd0-7b2e-480d-a8be-fcfa23bd863e",
									"type": "default"
								},
								{
									"key": "category_id",
								...
								},
								{
									"key": "main_small",
									"type": "file",
									"src": "/home/abb/Pictures/your-future-is-created-by-what-you-do-today-53172-1920x1200.jpg"
								},
								{
									"key": "main_medium",
									"type": "file",
								...
								},
								{
									"key": "small",
									"type": "file",
									"src": "/home/abb/Pictures/Quotefancy-76406-3840x2160.jpg"
								},
								{
									"key": "small",
									"type": "file",
				...
				},
				{
					...
					"request": {
						...
						"body": {
							...
							"formdata": [
								...
								},
								{
									"key": "main_small",
									"type": "file",
									"src": "/home/abb/Pictures/download.jpeg"
								},
								{
									"key": "main_medium",
									"type": "file",
						...
						"url": {
							"raw": "localhost:2406/admin/product/ff3ef680-3f35-4424-bc08-6fbb9c065675",
							"host": [
								"localhost"
							],
							"port": "2406",
							"path": [
								"admin",
								"product",
								"ff3ef680-3f35-4424-bc08-6fbb9c065675"
							]
						}
					},
					"response": []
				...
				},
				{
					...
					"request": {
						...
						"header": [],
						"url": {
							"raw": "localhost:2406/admin/product/dd531556-17ac-4e27-997e-57c0a48730f5",
							"host": [
								"localhost"
							],
							"port": "2406",
							"path": [
								"admin",
								"product",
								"dd531556-17ac-4e27-997e-57c0a48730f5"
							]
						}
					},
					"response": []
				},
				{
					...
					"request": {
						...
						"header": [],
						"url": {
							"raw": "localhost:2406/admin/restore-product/ff3ef680-3f35-4424-bc08-6fbb9c065675",
							"host": [
								"localhost"
							],
							"port": "2406",
				...
				},
				{
					...
					"request": {
						...
						"header": [],
						"url": {
							"raw": "localhost:2406/admin/delete-product/dd531556-17ac-4e27-997e-57c0a48730f5",
							"host": [
								"localhost"
							],
							"port": "2406",
