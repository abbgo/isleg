<template>
  <div class="product__box" @click.stop="$emit('productPopUp')">
    ...
    <div class="product__description">
      <p>Набор карандашей чёрнографитных в коробке 12 шт</p>
    </div>
    <div class="product__price">
      <div class="new__price">120.10 manat</div>
      <div class="old__price">213 manat</div>
    </div>
    <button
      class="product__add-btn"
      v-if="!isProductCount"
      @click.stop="isProductCount = true"
    >
      <svg
        width="27"
        height="27"
    ...
    <div class="chek__count box__count" v-else>
      <button>
        <svg
          width="8"
          height="4"
